...
const char* WIFI_SSID       = "Familia Matias";        // Nombre de tu red WiFi
const char* WIFI_PASSWORD   = "2004Sistem";   // Contraseña
...
const char* MQTT_BROKER     = "192.168.0.106";      // <── CAMBIA ESTO
...
float cachedLat = 20.06707123021223;
float cachedLon = -99.69249168209754;
